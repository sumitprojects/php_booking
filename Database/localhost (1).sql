...
--
-- Host: localhost
-- Generation Time: Apr 17, 2018 at 12:30 PM
...
(13, 'suhani', 'suhani', 'suhani', 'ppp', 'pppp', 'uuuu', '2018-04-16', 'Female', 'Un Married', 90989098, 'maiyti@gmail.com', 'suhani', 'suhani', 'Which is your favourite leader?', 'suhani', '');
...
(1, '101L', 'E.jpg', 'Deluxe Guest Room', '2', '$100', 'Loundry,Wi-Fi,Food,Room Service', 0, 'Enable', 1),
...
--
ALTER TABLE `registration`
  MODIFY `reg_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `billing`
  ADD CONSTRAINT `fk_book_id` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`booking_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
